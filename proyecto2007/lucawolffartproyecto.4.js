...
document.querySelector("#card-text1").innerHTML = ("valor: $" + cocacola.precio);

document.querySelector("#card-text2").innerHTML = ("valor: $" + pepsi.precio);

document.querySelector("#card-text3").innerHTML = ("valor: $" + chocolate.precio);

document.querySelector("#card-text4").innerHTML = ("valor: $" + helado.precio);
